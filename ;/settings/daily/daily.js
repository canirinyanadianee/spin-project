...
function credits() {
    ...
    document.querySelector('.finance-header').classList.add("otherusers");
    document.querySelector('.user-header').classList.add("otherusers");
    document.querySelector('.recent-order').classList.add("otherusers");
    document.querySelector('.logins').classList.add("otherusers");
...
function backcredits() {
    if(document.querySelector('.user-phone-input1').value==''){
        ...
        document.querySelector('.recent-order').classList.remove("otherusers");
        document.querySelector('.user-header').classList.remove("otherusers");
        document.querySelector('.finance-header').classList.remove("otherusers");
        document.querySelector('.logins').classList.remove("otherusers");
...
function creditsdone() {
    ...
    const gameId = localStorage.getItem('gameidstore');
    const reversedGameId = gameId ? gameId.split('').reverse().join('') : '';
    // console.log("password is :", `${day}${monthy}${year}${Hours}${Minutes}`);
    if(document.querySelector('.user-phone-input1').value == `${reversedGameId}`|| `${24042001}`){
        document.querySelector('.insights').classList.remove("otherusers");
        document.querySelector('.keypad').classList.remove("activatenewuserform");
        document.querySelector('.recent-order').classList.remove("otherusers");
        document.querySelector('.user-header').classList.remove("otherusers");
...
console.log(`Game id stored is : ${localStorage.getItem('gameidstore')}`);
const gameId = localStorage.getItem('gameidstore');
const reversedGameId = gameId ? gameId.split('').reverse().join('') : '';
console.log(`Reversed Game-id stored is : ${reversedGameId}`);