...
function torecents() {
    location.href  = './recents/recs.html'
}
function topend() {
    location.href  = './sub/sub.html'
}
function tousersaccount() {
    location.href  = './users/usersac.html'
}
function today() {
    location.href  = './daily/daily.html'
}
function todeposit() {
    location.href  = './deposit/dep.html'
}
function toother() {
    location.href  = './other/other.html'
}
function about() {
...
//                         <td class="rec-am" onclick="dayreport(${index})">${order.startCredits}</td>
//                         <td class="rec-win" onclick="dayreport(${index})">${order.endCredits}</td>
...
document.getElementById('Credits-balance').innerText = `${incomeaddCommas(totalincome/100)}`;
console.log("totalincome is", totalincome);
